...
public class Client2{
	...
	public void doConnection(){
		try{
			...
			client = new Socket("127.0.0.1",9999); // CLIENT 2 CONNECTS TO SERVER 2
            ...
            Client2MsgReadThread fetchMsg = new Client2MsgReadThread(is);
            Client2MsgWriteThread sendMsg = new Client2MsgWriteThread(os);
...
class Client2MsgReadThread extends Thread{
	public DataInputStream is = null;
	public String msg;
	public Client2MsgReadThread(DataInputStream i){
		is=i;
	}
	public void run(){
		while(true){
...
class Client2MsgWriteThread extends Thread{
	public DataOutputStream os = null;
	public String msg;
	public String mail;
	InputStreamReader isr = null;
	BufferedReader br = null;
	public Client2MsgWriteThread(DataOutputStream o){
		os=o;
